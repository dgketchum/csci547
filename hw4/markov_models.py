...
class FirstOrderMarkovModel(object):
    ...
    def build_transition_matrices(self):
        ...
        for k_1, tdict in self.transitions[1].iteritems():
    ...
    def generate_phrase(self):
        ...
        while w_minus_1 not in self.terminal_characters:
            w_minus_1 = np.random.choice(self.transitions[1][w_minus_1].keys(), replace=True,
                                         p=self.transitions[1][w_minus_1].values())
            phrase += w_minus_1 + ' '
        return phrase
...
class SecondOrderMarkovModel(object):
    ...
    def build_transition_matrices(self):
        ...
        for k_1, tdict_1 in self.transitions[2].iteritems():
            for k_2, tdict_2 in tdict_1.iteritems():
                key_sum = float(sum(tdict_2.values()))
                for k_3, v in tdict_2.iteritems():
    ...
    def generate_phrase(self):
        ...
        w_minus_1 = np.random.choice(self.transitions[1][w_minus_2].keys(), replace=True,
                                     p=self.transitions[1][w_minus_2].values())
